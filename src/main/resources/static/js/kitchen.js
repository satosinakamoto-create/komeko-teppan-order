/* ==========================================================================
   ...
   イートイン（卓ごとの QR）のお店なので、席についたお客さまから
   追加注文が何度も飛んできます。厨房が画面を見ていない間に注文が増えても
   気づけるよう、音と自動更新の 2 段構えにしています。

   画面の中身を JavaScript で書き換えるのではなく、まるごと読み直す方針です。
   チケットの並び・経過時間・押せるボタン・「同卓 ◯件」の数え上げは
   すべてサーバ側が持っているので、読み直すほうが
   「画面とサーバの食い違い」が起きず、コードもずっと短くなります。
